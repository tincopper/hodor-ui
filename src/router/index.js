    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/user_role',
          name: 'userRole',
          component: (resolve) => require(['@/components/user/Role'], resolve),
        },
        {
          path: '/user_manage',
          name: 'userManage',
        ...
        },
        {
          path: '/work_flow',
          name: 'workFlow',
          component: (resolve) => require(['@/components/WorkFlow'], resolve),
        },
        {
          path: '/help',
          name: 'help',
          component: (resolve) => (window.location.href = window.location.href),
