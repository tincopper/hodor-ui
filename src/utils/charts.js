...
import { crossOptions } from './cross'
...
export const initOptions = (
  ...
  if (chartType == 'pie') {
    ...
    options.series.push(
      creatSeriesObj(data.values, title, null, chartType, colorFul, barWidth)
    )
    ...
    for (let key in data) {
      options.series.push(
        creatSeriesObj(data[key].data, data[key].name, null, chartType)
      )
    }
  }
