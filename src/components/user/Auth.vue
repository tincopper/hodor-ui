<template>
  <div class="user-action-container">
    <el-row v-if='activeTab==0'>
      ...
      <el-col :span="4">
        <el-select v-model="username" filterable placeholder="请选择用户" size="small" class="width100" @change="changeName">
      ...
      <el-col :span="6">
        <el-checkbox-group v-model="authtype" size="small" @change="changecheckBox">
          <el-checkbox-button :label="item.val" v-for='item in authTitle' :key='item.val'>{{item.label}}</el-checkbox-button>
        </el-checkbox-group>
      </el-col>
    </el-row>
    <el-row v-if='activeTab==1'>
      ...
      <el-col :span="8">
        <el-select v-model="roleId" filterable placeholder="请选择角色" size="small" class="width100" @change='changeRole'>
          <el-option v-for="item in roleList" :key="item.id" :label="item.roleName" :value="item.id">
          </el-option>
        </el-select>
      </el-col>
      &nbsp;
      <el-button type="primary" size="small" @click="authSumbit('ztree-menu')">给角色授权</el-button>
      <el-col>
    ...
    <el-tabs type="border-card" @tab-click='tabClickHandle'>
      <el-tab-pane label="组授权">
        <el-row>
          <el-col :span='10'>
            <el-input placeholder="输入关键字进行过滤" v-model="filterGroup" size="small" v-if='false'>
            </el-input>
            <div id="ztree-group" class="ztree"></div>
          </el-col>
        </el-row>
      ...
      <el-tab-pane label="操作授权">
        <el-row>
          <el-col :span='10'>
            <el-input placeholder="输入关键字进行过滤" v-model="filterText" size="small" v-if='false'>
            </el-input>
            <div id="ztree-menu" class="ztree"></div>
          </el-col>
        </el-row>
        <el-row>
